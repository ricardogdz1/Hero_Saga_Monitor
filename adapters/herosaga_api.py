...
def item_card_meta_from_details(details: dict, *, item_card_keys: tuple) -> dict:
    return app_services.item_card_meta_from_details(details, item_card_keys=item_card_keys)
...
def collect_price(
    ...
    *,
    ...
    return app_services.collect_price(
        item_id,
        item_data,
        load_prices_history_fn=load_prices_history_fn,
        save_prices_history_fn=save_prices_history_fn,
...
def sync_iwork_name_from_sources(
    ...
    *,
    ...
    return app_services.sync_iwork_name_from_sources(
        iwork,
        history_data,
