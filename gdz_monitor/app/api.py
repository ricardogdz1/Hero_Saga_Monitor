"""
Ponte Python ↔ JS da aplicação (pywebview).
...
from gdz_monitor.adapters.herosaga_client import HerosagaClient
from gdz_monitor.adapters.herosaga_session import (
...
from gdz_monitor.adapters.persistence import (
    _ALERTS_IO_LOCK,
    load_alerts,
    load_data,
    save_alerts,
...
from gdz_monitor.core.settings import (
    load_settings,
    save_settings,
    set_windows_autostart,
)
from gdz_monitor.services.market.runtime import (
...
from gdz_monitor.services.market.item_search import ItemSearchService
from gdz_monitor.services.market.monitored import splice_category_block
from gdz_monitor.services.market.search_history import append_search as _append_search
from gdz_monitor.app.alert_worker import get_alert_worker
from gdz_monitor.app.discord_login import open_discord_login_window
...
def _build_slot_price(iid: int, refine: int, stores=None) -> dict:
    ...
    from gdz_monitor.services.build.simulator import filter_stores_slot, min_prices_from_stores
...
class Api:
    ...
    def get_vendor_shop(self, vendor_id) -> dict:
        ...
        from gdz_monitor.services.market.vendor_shop import fetch_vendor_shop
    ...
    def add_alert(self, payload) -> dict:
        ...
        try:
            from gdz_monitor.services.alert_monitor import (
    ...
    def test_email(self, payload) -> dict:
        ...
        from gdz_monitor.services.alert_monitor import send_alert_email
    ...
    def test_divine_pride(self, payload) -> dict:
        ...
        try:
            from gdz_monitor.external.divine_pride_api import fetch_item
    ...
    def _loot(self):
        if getattr(self, "_loot_mgr", None) is None:
            from gdz_monitor.services.loot_manager import LootManager
    ...
    def loot_search(self, query) -> dict:
        from gdz_monitor.services.loot_manager import search_item, search_items_by_ids
    ...
    def loot_add(self, group_number, item) -> dict:
        from gdz_monitor.services.loot_manager import LootItem, resolve_loot_item_meta
    ...
    def loot_add_group(self) -> dict:
        from gdz_monitor.services.loot_manager import LootGroup
    ...
    def build_meta(self) -> dict:
        from gdz_monitor.services.build.simulator import BUILD_SLOT_LEFT, BUILD_SLOT_RIGHT, SLOT_LABELS_PT
        from gdz_monitor.services.build.characters import SERVER_LIMITS, class_catalog, default_character
        from gdz_monitor.services.build.stats import stat_schema
    ...
    def build_list(self) -> dict:
        from gdz_monitor.services.build.simulator import load_builds_file
    ...
    def build_load(self, build_id) -> dict:
        from gdz_monitor.services.build.simulator import (
            BUILD_SLOT_LEFT, BUILD_SLOT_RIGHT, default_slot_state, load_builds_file,
        )

        from gdz_monitor.services.build.stats import normalize_base_stats, parse_weapon_base
        from gdz_monitor.services.build.characters import normalize_character
    ...
    def build_resolve(self, query, refine) -> dict:
        ...
        from gdz_monitor.services.market.runtime import api_search_item_names
        from gdz_monitor.services.build.simulator import item_meta_is_two_handed
        from gdz_monitor.services.build.stats import parse_item_stats, parse_weapon_base
    ...
    def build_save(self, payload) -> dict:
        ...
        from gdz_monitor.services.build.stats import normalize_base_stats
        from gdz_monitor.services.build.characters import normalize_character
    ...
    def build_delete(self, build_id) -> dict:
        ...
        from gdz_monitor.services.build.simulator import load_builds_file, save_builds_file
    ...
    def mvp_cards(self, filter_mode="todos", query="") -> dict:
        from gdz_monitor.services.mvp_timer import (
    ...
    def mvp_sprite(self, monster_id, name="") -> dict:
        from gdz_monitor.services.mvp_timer import resolve_mob_image
    ...
    def mvp_register(self, monster_id) -> dict:
        from gdz_monitor.external.divine_pride_api import fetch_monster
        from gdz_monitor.services.mvp_timer import (
    ...
    def mvp_get_entry(self, entry_id) -> dict:
        from gdz_monitor.services.mvp_timer import load_mvp_catalog_cache, load_mvp_storage
    ...
    def mvp_save_entry(self, entry_id, patch) -> dict:
        from gdz_monitor.services.mvp_timer import load_mvp_storage, next_spawn_at, parse_user_datetime, save_mvp_storage
    ...
    def mvp_reset_all(self) -> dict:
        from gdz_monitor.services.mvp_timer import load_mvp_storage, save_mvp_storage
    ...
    def mvp_map(self, map_name) -> dict:
        from gdz_monitor.services.mvp_timer import build_mvp_map_click_mask_from_image, resolve_map_image
    ...
    def mvp_check_spawns(self) -> dict:
        ...
        from gdz_monitor.services.mvp_timer import load_mvp_storage, save_mvp_storage, seconds_until_spawn
    ...
    def drop_calc_get_catalog(self) -> dict:
        from gdz_monitor.services.drop_calculator import load_maps_catalog
    ...
    def drop_calc_get_map(self, map_id) -> dict:
        from gdz_monitor.services.drop_calculator import filter_mapa_for_display, load_maps_catalog
    ...
    def drop_calc_compute(
        ...
        from gdz_monitor.services.drop_calculator import compute_drop_row
    ...
    def drop_calc_get_item_meta(self) -> dict:
        ...
        from gdz_monitor.services.drop_calculator import build_drop_item_meta_index
    ...
    def drop_calc_resolve_item_ids(self, names, hints=None) -> dict:
        ...
        from gdz_monitor.services.drop_calculator import resolve_drop_items_meta_local
