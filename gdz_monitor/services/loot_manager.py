...
from gdz_monitor.external.item_icon_cache import item_icon_disk_path, read_item_icon_png_bytes
...
def _hs_item_name(item_id: int) -> str:
    ...
    try:
        from gdz_monitor.services.market.runtime import get_stores_from_item_page
...
def search_item(query: str) -> List[dict]:
    ...
    from gdz_monitor.adapters.network import scraper as hs_scraper
