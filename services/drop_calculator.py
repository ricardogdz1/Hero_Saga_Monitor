...
def build_drop_item_meta_index() -> dict:
    ...
    from item_icon_cache import read_cached_icon_data_uri
...
def _cache_entry_from_item_id(
    ...
    *,
    ...
    from core.constants import BASE_URL as _BASE
    from item_icon_cache import item_icon_disk_path
