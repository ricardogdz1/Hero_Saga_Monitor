...
def format_home_min_prices(m: dict, *, fmt_price_stores_fn: Callable) -> str:
    return app_domain.format_home_min_prices_for_monitored(m, fmt_price_stores=fmt_price_stores_fn)
...
def layout_dims(settings: dict) -> tuple:
    ...
    from core.constants import MH_CATEGORY_COL_MIN_WIDTH, MH_MIN_VISIBLE_CATEGORY_COLS
